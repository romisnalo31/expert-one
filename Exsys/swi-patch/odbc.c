/*  $Id: odbc.c,v 1.74 2007/01/19 16:11:32 jan Exp $
...
{ unsigned int flags = CVT_ATOM|CVT_STRING|REP_UTF8;
  const char *expected = "text";

  switch(prm->plTypeID)
  { case SQL_PL_DEFAULT:
      flags = CVT_ATOM|CVT_STRING|REP_UTF8;
      expected = "text";
      break;
    case SQL_PL_ATOM:
      flags = CVT_ATOM|REP_UTF8;
      expected = "atom";
      break;
    case SQL_PL_STRING:
      flags = CVT_STRING|REP_UTF8;
      expected = "string";
      break;
    case SQL_PL_CODES:
      flags = CVT_LIST;
...
{ switch( plTypeID )
  { case SQL_PL_DEFAULT:
    case SQL_PL_ATOM:
      PL_put_variable(val);
      PL_unify_chars(val, PL_ATOM|REP_UTF8, len, chars);
      break;
    case SQL_PL_STRING:
      PL_put_variable(val);
	  PL_unify_chars(val, PL_STRING|REP_UTF8, len, chars);
      break;
    case SQL_PL_CODES:
